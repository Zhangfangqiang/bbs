    ...
    <div class="layui-card">
      ...
      <div class="layui-card-body">
        <div style="overflow: hidden;padding-bottom: 10px;">
          <button id="permissions-create" class="layui-btn layuiadmin-btn-list" data-type="add" style="float: right;">
            添加
          </button>
        </div>
    ...
    $layui.use(['index', 'table', 'laydate'], function () {
      ...
      table.render({
        ...
        cols: [[
          ...
          {width: 160, title: "操作", align: "center", fixed: "right", toolbar: "#permissions-operation"}
        ]],
        page: !0,
        limit: 15,
